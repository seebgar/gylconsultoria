...
var SeedComponent = /** @class */ (function () {
    ...
    SeedComponent.prototype.reply = function () {
        if (this.new_reply !== '' && this.new_reply !== undefined && this.new_reply !== null) {
            var x = {
                //author,
                // author_image
                date: '' + new Date().toLocaleString(),
...
module.exports = __webpack_require__(/*! /Users/sebastiangarcia/Documents/Proyects/garcialopez/garcialopez/src/main.ts */"./src/main.ts");
